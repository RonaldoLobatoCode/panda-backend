...
@NoArgsConstructor
@Builder
@Table(name = "users", uniqueConstraints = {@UniqueConstraint(columnNames = {"numIdentidad"}),@UniqueConstraint(columnNames = {"email"})})
public class User {
    @Id
    ...
    @Size(max = 50, message = "Este campo solo puede tener un máximo de 20 caracteres.")
